...
-- at runtime using the environment variable integra_bindir.
...
-- environment variable integra_libdir.
...
-- using the environment variable integra_dynlibdir.
...
-- runtime using the environment variable integra_datadir.
...
-- using the environment variable integra_sysconfdir.
...
libdir     = "/home/alex/.cabal/lib/x86_64-linux-ghc-9.10.3-21af/integra-0.5.0.0-inplace-integra-web"
dynlibdir  = "/home/alex/.cabal/lib/x86_64-linux-ghc-9.10.3-21af"
datadir    = "/home/alex/.cabal/share/x86_64-linux-ghc-9.10.3-21af/integra-0.5.0.0"
libexecdir = "/home/alex/.cabal/libexec/x86_64-linux-ghc-9.10.3-21af/integra-0.5.0.0"
sysconfdir = "/home/alex/.cabal/etc"

getBinDir     = catchIO (getEnv "integra_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "integra_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "integra_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "integra_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "integra_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "integra_sysconfdir") (\_ -> return sysconfdir)
